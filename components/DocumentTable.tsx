        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div className="flex justify-between items-center px-6 py-4 border-b bg-white">
                ...
                <div className="flex items-center gap-3">
                    <label className="flex items-center gap-2 px-4 py-2 bg-black text-white rounded-lg text-sm cursor-pointer hover:bg-black/90 transition">
                    ...
                    ${doc.status === "completed"
                                    ...
                                    <td className="text-right pr-6">
                                        <div className="opacity-0 group-hover:opacity-100 transition flex justify-end gap-4">
                                            <button onClick={() => handleView(doc._id)} className="text-blue-600 text-xs font-medium hover:underline">
                                                View
                                            </button>
                                            <button onClick={() => handleDelete(doc._id)} className="text-red-500 cursor-pointer text-xs font-medium hover:underline">
                                                Delete
                                            </button>
                                        </div>
                                    </td>
            ...
            {selectedDocId && (
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-xl w-[600px] p-6 shadow-lg relative">
                        ...
                        {docData && (
                            <div>
                                ...
                                <p className="text-sm text-gray-500 whitespace-pre-line">
                                    {docData.text || "No content extracted from this document."}
                                </p>
                            </div>
                        )}
                    </div>
